...
export default function ButtonCard({isDark, text,href}: BottonCardProps){
    return(
        <Link href={href} target="blank" className={ `${isDark ? "bg-secondary-color" : "bg-primary-color"} flex justify-center rounded-xl mt-1 shadow-md w-fit hover:scale-105 duration-150`}>
