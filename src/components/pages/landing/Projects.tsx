            ...
            <div className="md:w-[60%] my-12 flex flex-col justify-start items-center flex-wrap">
                ...
                <div className="flex flex-row gap-4 md:gap-16 justify-center items-center mt-12 flex-wrap animation-appear ">
                    <ProjectCard
                        src="/blog_tech.png"
                        alt="Ejemplo de blog"
                        descripcion="Hecho con React y base de datos en Firebase. Cuenta con autenticacion (Firebase con Google Auth), busqueda, crear posts."
                        text="Ejemplo de blog tecnologico"
                        link="https://blog-tecnologico.vercel.app/"
                        linkGithub="https://github.com/hojadev/blog-tecnologico"
                    />
                    <ProjectCard
                        src="/proyect_4.jpeg"
